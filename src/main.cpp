...
int main(int argc, char *argv[]) {
    ...
    app.setApplicationName(QStringLiteral("oma12c"));
    app.setDesktopFileName(QStringLiteral("oma12c"));
    app.setWindowIcon(QIcon::fromTheme(QStringLiteral("oma12c")));
    ...
    if (engine.rootObjects().isEmpty()) {
        qCritical() << "Could not load the OMA12C interface; resource available:"
